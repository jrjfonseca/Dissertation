...
set yrange [-1000:7046]
set ytics mirror
# X axis
set xrange[1446.6:1496.6] reverse
...
plot "Au_shirley.txt" using 1:2 w l lc rgb "black", \
     "Au_shirley.txt" every ::281::439 using 1:3  w l lc rgb "red", \
     "Au_shirley.txt" every ::281::439 using 1:4 w l lc rgb "blue", \
     "Au_shirley.txt" every ::281::439 using 1:5 w l lc rgb "orange", \
     "Au_shirley.txt" every ::281::439 using 1:6 w l lc rgb "purple", \
     "Au_shirley.txt" every ::281::439 using 1:7 w l lc rgb "green", \

set terminal pdfcairo enhanced color notransparent size 16cm,12cm 
set output 'Au_shirley.pdf'
replot
unset output
unset terminal
